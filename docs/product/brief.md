...
A collection item links a stamp to a collector's holding: condition, quantity, acquisition source, purchase price, whether it is available for trade or sale, and any notes.
