...
catalog numbers, area, and any **photos** on the stamp (click a thumbnail to open it full-size),
plus any prices already recorded for it (across editions, conditions, and certificates) so you
can price consistently — the target row is marked with an arrow. (For fuller edits, a copy's **⋮** menu → **Edit stamp** opens the **Prices** tab.) Then
try the close again.
