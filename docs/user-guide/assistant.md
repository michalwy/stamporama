...
round: an offer being prepared knows which of its stamps have no Colnect item-ID, and its **Items**
card can hand them over one at a time — **⚡ Link** on a row, or **⚡ Link all** for the
whole gap. Each opens that stamp's Colnect search in a tab beside the offer and brings this window up
on it; you match as usual — confirm a candidate or press **Write** — and the item-ID appears on the
...
the line stating when it started, beside the buyer, gains a small mark:
