...
Tags go on **issues** and on **stamps**. (Copies are coming separately.)
...
Each row says what the tag is on — *On 3 issues and 12 stamps*, or *Not used yet*.
...
**Delete** takes the tag off everything carrying it. The confirmation says how many issues and how
many stamps that is, and nothing else about them changes — no copy, price, checklist or catalogue
...
- on the **issue's** and the **stamp's** own screens, on the line that names them
