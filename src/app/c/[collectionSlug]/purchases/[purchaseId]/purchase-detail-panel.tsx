...
function LotCard({
  ...
  // from `prefers-reduced-motion` — under that preference the flash holds still instead of fading
  // (#877), and a page smooth-scrolling itself would have been the one piece of motion left (#1022).
