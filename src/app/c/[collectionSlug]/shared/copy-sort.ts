...
// Copy-list sorting shared by the purchase-order lot view (#157) and the sale-lot composition
// view (#164) so both order copies identically. Sorts on the same fields the rows show.
